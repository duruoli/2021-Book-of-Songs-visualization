...
###import data
df_sh<-read.csv("D:/A李杜若/留学/科研/可视化_王懿芳学姐/Book of Songs/data/add/glyph_荼.csv")
df_sh<-df_sh[,c(1,4,5,6)]
...
write.csv(df_sh_all,"D:/A李杜若/留学/科研/可视化_王懿芳学姐/Book of Songs/data/New/glyph_荼.csv", row.names = F)
