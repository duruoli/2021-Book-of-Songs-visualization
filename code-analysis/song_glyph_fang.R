...
###import data
df_sh<-read.csv("C:/Users/ldr/Desktop/data/glyph/glyph_öÐ.csv")
...
write.csv(df_sh_all,"C:/Users/ldr/Desktop/data/glyph/react_glyph/glyph_öÐ.csv", row.names = F)

############end###########

##image_öÐ
img_sh = data.frame(matrix(nrow = 3, ncol = 6))

colnames(img_sh)<-c('name','n','a1','a2','r','ratio')

img_sh$name<-c('Âí','Óã','÷r')
img_sh$n<-c(5,6,3)
...
###output
#relate
write.csv(img_sh,"C:/Users/ldr/Desktop/data/glyph/react_glyph/relate_f.csv", row.names = F)
