...
###import data
df_sh<-read.csv("C:/Users/ldr/Desktop/data/glyph/glyph_Âí.csv")
...
write.csv(df_sh_all,"C:/Users/ldr/Desktop/data/glyph/react_glyph/glyph_Âí.csv", row.names = F)
...
img_sh$name<-c('¼¬','Êò','É£','Ñà','Å£','Ñò')
img_sh$n<-c(9,10,11,12,9,8)
...
###output
#relate
write.csv(img_sh,"C:/Users/ldr/Desktop/data/glyph/react_glyph/relate_m.csv", row.names = F)
