...
###import data
df_sh<-read.csv("C:/Users/ldr/Desktop/data/glyph/glyph_Ñà.csv")
...
rownames(col_id)<-c('°®','Ï²','Óû','ÖÐÐÔ','¾å','°§','Å­','¶ñ')
...
write.csv(df_sh_all,"C:/Users/ldr/Desktop/data/glyph/react_glyph/glyph_Ñà.csv", row.names = F)

############end###########

##image_Ñà
img_sh = data.frame(matrix(nrow = 6, ncol = 6))

colnames(img_sh)<-c('name','n','a1','a2','r','ratio')

img_sh$name<-c('ð¢','¼¬','Êò','Âí','Â¹','Å£')
img_sh$n<-c(2.5,2.5,3.5,8,5,4)##8->28
...
###output
#relate
write.csv(img_sh,"C:/Users/ldr/Desktop/data/glyph/react_glyph/relate_y.csv", row.names = F)
