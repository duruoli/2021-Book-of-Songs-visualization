...
###import data
df_sh<-read.csv("C:/Users/ldr/Desktop/data/glyph/glyph_桑.csv")
...
df_sh2<- df_sh %>% 
  ...
  summarise(n2=n())  %>%
  mutate(r=n2/sum(n2)) 
#%>% mutate(id=row_number()) 会根据emo分组标123..
...
write.csv(df_sh_all,"C:/Users/ldr/Desktop/data/glyph/react_glyph/glyph_桑.csv", row.names = F)

############end###########

##image_桑
img_sh = data.frame(matrix(nrow = 10, ncol = 6))

colnames(img_sh)<-c('name','n','a1','a2','r','ratio')

img_sh$name<-c('黍','稻','穀','荼','棘','来','马','鸱鸮','鹿','鸠')
img_sh$n<-c(3,3,4,4,4,7,17-7,4,3,3) 
...
###output
#relate
write.csv(img_sh,"C:/Users/ldr/Desktop/data/glyph/react_glyph/relate_s.csv", row.names = F)



#icicle
write.csv(df_sh1,"C:/Users/ldr/Desktop/data/glyph/react_glyph/glyph_桑1.csv", row.names = F)
write.csv(df_sh21,"C:/Users/ldr/Desktop/data/glyph/react_glyph/glyph_桑2.csv", row.names = F)
write.csv(df_sh31,"C:/Users/ldr/Desktop/data/glyph/react_glyph/glyph_桑3.csv", row.names = F)
write.csv(df_sh41,"C:/Users/ldr/Desktop/data/glyph/react_glyph/glyph_桑4.csv", row.names = F)
